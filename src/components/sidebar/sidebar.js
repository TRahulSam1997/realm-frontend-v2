...
const SideBar = () => {
    ...
    return (
        <div className="h-72 flex border border-black rounded p-6 my-4 w-full dark:border-gray-800 bg-gray-900 dark:bg-blue-opaque">
          <div className="m-auto">
            <p className="text-lg text-center md:text-2xl font-bold text-gray-300 dark:text-gray-100">Subscribe to our Newsletter for More.</p>
